#
#  Be sure to run `pod spec lint FFGeneralProject.podspec' to ensure this is a
...
Pod::Spec.new do |s|
 ...
 使用从0.0.2版本开始
  ...
  s.author             = { "阿飞" => "2326439727@qq.com" }
  # Or just: s.author    = "吉飞飞"
  # s.authors            = { "吉飞飞" => "2326439727@qq.com" }
  # s.social_media_url   = "http://twitter.com/吉飞飞"
  ...
  # s.resource_bundles = {'testPlaceSDK' => ['testPlaceSDK/Assets/**/*.{h,m}']}
